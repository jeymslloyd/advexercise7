...
const Login = () => {
    ...
    return (
        <div className="h-screen flex justify-center items-center bg-login-background">
            <div className="w-1/2 rounded-md bg-white flex justify-between flex-col">
                <div className="h-28 w-full justify-center flex items-center">
                    <span className="text-3xl text-black font-serif  font-semibold p-3 rounded-lg">Welcome</span>
                </div>
